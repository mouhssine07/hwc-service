...
public class PaysAdminController {

    private final PaysService service;

    @GetMapping
    public ResponseEntity<Page<PaysDTO>> getAll(Pageable pageable) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PaysDTO> update(@PathVariable Long id, @Valid @RequestBody PaysDTO dto) {
