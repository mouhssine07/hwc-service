  ...
  highlights: [
    {
      ...
      description: "Google Ads, Meta Ads, LinkedIn Ads et stratégies d'inbound marketing pour couvrir vos canaux.",
    },
    {
      title: "Lead Booster",
      description: "Plateforme propriétaire propulsée par l'IA qui génère et qualifie automatiquement vos leads.",
    },
    {
      title: "Lead nurturing",
      description: "Séquences automatisées pour accompagner vos prospects jusqu'à la conversion finale.",
    },
    {
      title: "Pilotage par la donnée",
      description: "Suivi des coûts, des volumes, des conversions et de la performance des campagnes.",
    },
  ],
